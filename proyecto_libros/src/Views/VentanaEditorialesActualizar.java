...
public class VentanaEditorialesActualizar extends JFrame {
	...
	public VentanaEditorialesActualizar() {
		...
		JButton CreateButton = new JButton("Actualizar editorial");
		CreateButton.setBounds(13, 193, 157, 23);
		...
		CreateButton.addActionListener( e -> {
			...
			try {
				...
				Navegador.mostrarMensajeError(VentanaEditorialesActualizar.this, "Error", "Año de fundación no válido");
				return;
			}
			try {
				...
				Navegador.mostrarMensajeError(VentanaEditorialesActualizar.this, "Error", "Número de teléfono no válido");
				return;
			}
	...
	public void setData(Editorial e) {
		id = e.getId();
		nameTextField.setText(e.getNombre());
		nationTextField.setText(e.getPais());
		cityTextField.setText(e.getCiudad());
		yearTextField.setText(e.getAnoFundacion() + "");
		phoneTextField.setText(e.getTelefono() + "");
