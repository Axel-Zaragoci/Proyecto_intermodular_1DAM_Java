...
public class VentanaAutoresCrear extends JFrame {
	...
	public VentanaAutoresCrear() {
		setLocationRelativeTo(Navegador.obtenerVentana("Autores"));
		...
		CreateButton.addActionListener( e -> {
			...
			if (!(year == month && month == day)) {
				Navegador.mostrarMensajeError(VentanaAutoresCrear.this, "Error", "O todas las partes de la fecha deben tener datos o ninguna");
				return;
			}
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				...
				Navegador.obtenerVentana("Autores").setLocationRelativeTo(VentanaAutoresCrear.this);
